  ...
  _createClass(Carousel, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.children.length > children.length) {
        ...
        var isOutOfRange = activeIndex + itemsToShow > lastIndex;
    ...
    value: function render() {
      ...
      var _this$getDerivedProps10 = this.getDerivedPropsFromBreakPoint(),
          className = _this$getDerivedProps10.className,
          style = _this$getDerivedProps10.style,
          ...
          easing = _this$getDerivedProps10.easing,
          tiltEasing = _this$getDerivedProps10.tiltEasing,
          transitionMs = _this$getDerivedProps10.transitionMs,
          children = _this$getDerivedProps10.children,
          focusOnSelect = _this$getDerivedProps10.focusOnSelect,
          autoTabIndexVisibleItems = _this$getDerivedProps10.autoTabIndexVisibleItems,
          itemPosition = _this$getDerivedProps10.itemPosition,
          itemPadding = _this$getDerivedProps10.itemPadding,
          enableSwipe = _this$getDerivedProps10.enableSwipe,
          enableMouseSwipe = _this$getDerivedProps10.enableMouseSwipe,
          pagination = _this$getDerivedProps10.pagination,
          showArrows = _this$getDerivedProps10.showArrows,
          disableArrowsOnEnd = _this$getDerivedProps10.disableArrowsOnEnd,
          preventDefaultTouchmoveEvent = _this$getDerivedProps10.preventDefaultTouchmoveEvent,
          renderArrow = _this$getDerivedProps10.renderArrow,
          renderPagination = _this$getDerivedProps10.renderPagination;
